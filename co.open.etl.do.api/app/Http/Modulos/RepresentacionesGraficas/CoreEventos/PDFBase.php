...
class PDFBase extends Fpdf {
     ...
     * @return mixed
     */
    public static function buildPdfManager(string $ofeIdentificacion, string $baseDatos) {
        ...
        if ($oferente->ofe_recepcion_correo_estandar === 'SI')
            $clase = 'App\\Http\\Modulos\\RepresentacionesGraficas\\Eventos\\etl_generica\\rgGenerica\\PDFGENERICA';
        else 
            $clase = 'App\\Http\\Modulos\\RepresentacionesGraficas\\Eventos\\' . $baseDatos . '\\rg' . $ofeIdentificacion . '\\PDF' . $ofeIdentificacion;

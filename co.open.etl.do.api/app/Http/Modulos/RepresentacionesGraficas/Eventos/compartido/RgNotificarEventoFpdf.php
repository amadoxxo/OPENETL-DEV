...
class RgNotificarEventoFpdf extends Fpdf {
    /**
     * Imagen a utilizar en el encabezado
     *
     * @var string
     */
    ...
    /**
     * Array con la data de notificación del evento.
     *
     * @var array
     */
    public $dataNotificarEvento = [];
    ...
    public function __construct($dataNotificarEvento) {
        ...
        $this->dataNotificarEvento = $dataNotificarEvento;
    }

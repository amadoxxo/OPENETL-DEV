...
class ConfiguracionObligadoFacturarElectronicamente extends TenantConfiguracionObligadoFacturarElectronicamente {
    ...
    /**
     * Obtiene la razon social del oferente.
     *
     * @param  string $value
     * @return void
     */
    ...
    /**
     * Asigna el twitter del oferente.
     *
     * @param  string $value
     * @return void
     */
    ...
    /**
     * Asigna el facebook del oferente.
     *
     * @param  string $value
     * @return void
     */
    ...
    // INICIO RELACIONES
    /**
     * Relación para obtener la base de datos relacionada al oferente.
     *
     * @return BelongsTo
     */

...
import {ConceptosCorreccionGestionarComponent} from './conceptos_correccion_gestionar.component';


@NgModule({
    declarations: [
        ConceptosCorreccionGestionarComponent
    ],
    imports: [
        FuseSharedModule,
        LoaderModule,
...
export class ConceptosCorreccionGestionarModule {}
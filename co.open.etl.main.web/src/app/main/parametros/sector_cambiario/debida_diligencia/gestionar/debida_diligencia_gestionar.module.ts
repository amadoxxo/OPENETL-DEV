...
import {DebidaDiligenciaGestionarComponent} from './debida_diligencia_gestionar.component';


@NgModule({
    declarations: [
        DebidaDiligenciaGestionarComponent
    ],
    imports     : [
        FuseSharedModule,
        LoaderModule,
...
export class DebidaDiligenciaGestionarModule {}
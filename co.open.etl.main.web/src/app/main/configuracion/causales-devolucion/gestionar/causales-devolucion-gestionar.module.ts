...
import {CausalesDevolucionGestionarComponent} from './causales-devolucion-gestionar.component';


@NgModule({
    declarations: [
        CausalesDevolucionGestionarComponent
    ],
    imports: [
        FuseSharedModule,
        LoaderModule,
...
export class CausalesDevolucionGestionarModule {}
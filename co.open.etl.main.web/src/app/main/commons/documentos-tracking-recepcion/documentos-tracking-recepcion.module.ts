...
import { DocumentosTrackingRecepcionComponent } from './documentos-tracking-recepcion.component';
...
@NgModule({
    declarations: [DocumentosTrackingRecepcionComponent],
    imports: [
        CommonModule,
        FlexLayoutModule,
        FuseSharedModule,
    ...
    exports: [
        DocumentosTrackingRecepcionComponent
    ],
    schemas: [CUSTOM_ELEMENTS_SCHEMA]
})
export class DocumentosTrackingRecepcionModule {}
